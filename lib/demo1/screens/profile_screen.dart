...
class _ProfileState extends State<Profile> with SingleTickerProviderStateMixin{
                      ...
                      flex:1,
                        child: Column(
                          ...
                          children: [
                            ...
                            _textUtils.normal16('Ana', Colors.black),
                          ],
                    ),
                    ),
                    Expanded(
                      flex: 2,
                        child: Row(
                          ...
                          children: [
                            Column(
                              children: [
                                _textUtils.bold20('16', Colors.black),
                            ...
                            Column(
                              children: [
                                _textUtils.bold20('1,456', Colors.black),
                                const SizedBox(height: 5,),
                            ...
                            Column(
                              children: [
                                _textUtils.bold20('456', Colors.black),
                                const SizedBox(height: 5,),
                ...
                child: Row(
                  children: [
                    Expanded(flex:8,child: Container(
                      ...
                      child: Center(
                        child: _textUtils.normal16('Edit Profile', Colors.black),
                      ),
                    ),
                    ),
                  ...
                  children: [
                    Expanded(child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 5,),
                        _textUtils.normal14('Keep your favourite stories on your profile',
                            Colors.black),
                      ],
                    ),
                      flex: 9,
                    ...
                    children: [
                      ...
                      child: Column(
                        children: [
                          ...
                          const SizedBox(height: 10,),
                          _textUtils.normal12('New', Colors.black),
                        ],
                      ),),
  ...
  Widget favouriteStoriesWidget(){
    return const Padding(padding: EdgeInsets.only(right: 10,left: 10),
    child: CircleAvatar(
      radius: 33,
